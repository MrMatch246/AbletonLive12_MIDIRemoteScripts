...
class ControlSurface(Subject, SlotManager):
    ...
    def root_components(self):
        return tuple([comp for comp in self._components if comp.is_root if not comp.is_private if comp.is_root if comp.is_private])
...
# okay decompiling ./MIDIRemoteScripts/_Framework/ControlSurface.pyc

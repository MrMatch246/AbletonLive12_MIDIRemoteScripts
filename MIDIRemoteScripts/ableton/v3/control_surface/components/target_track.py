...
class ArmedTargetTrackComponent(TargetTrackComponent):
    ...
    def _tracks(self):
        return [t for t in self.song.tracks if liveobj_valid(t) if t.can_be_armed if liveobj_valid(t) if t.can_be_armed]

# okay decompiling ./MIDIRemoteScripts/ableton/v3/control_surface/components/target_track.pyc

...
Instruction context:
 ...
 L.  79       136  JUMP_FORWARD        138  'to 138'
               138_0  COME_FROM           136  '136'
               138_1  COME_FROM           134  '134'
               138_2  COME_FROM           126  '126'
               138_3  COME_FROM           116  '116'
               138_4  COME_FROM            82  '82'
               138_5  COME_FROM            72  '72'
->             138_6  COME_FROM            42  '42'
...
call ::= expr . pos_arg pos_arg pos_arg pos_arg pos_arg pos_arg pos_arg CALL_METHOD_7
call ::= expr CALL_METHOD_0 . 
call ::= expr pos_arg . CALL_FUNCTION_1
call ::= expr pos_arg . CALL_METHOD_1
call ::= expr pos_arg . pos_arg CALL_FUNCTION_2
...
Instruction context:
 ...
 L. 325       284  LOAD_FAST                'self'
                 286  LOAD_METHOD              song
                 288  CALL_METHOD_0         0  '0 positional arguments'
                 290  LOAD_METHOD              stop_all_clips
                 292  CALL_METHOD_0         0  '0 positional arguments'
                 294  POP_TOP          
                 296  JUMP_FORWARD        298  'to 298'
               298_0  COME_FROM           296  '296'
               298_1  COME_FROM           280  '280'
               298_2  COME_FROM           270  '270'
               298_3  COME_FROM           262  '262'
               298_4  COME_FROM           242  '242'
               298_5  COME_FROM           224  '224'
->             298_6  COME_FROM           126  '126'

...
Instruction context:
 ...
 L. 111       166  LOAD_FAST                'self'
                 168  LOAD_METHOD              _MixerController__handle_transport_ccs
                 170  LOAD_FAST                'cc_no'
                 172  LOAD_FAST                'cc_value'
                 174  CALL_METHOD_2         2  '2 positional arguments'
                 176  POP_TOP          
                 178  JUMP_FORWARD        180  'to 180'
               180_0  COME_FROM           178  '178'
               180_1  COME_FROM           164  '164'
               180_2  COME_FROM           156  '156'
               180_3  COME_FROM           122  '122'
               180_4  COME_FROM           112  '112'
               180_5  COME_FROM            82  '82'
               180_6  COME_FROM            72  '72'
->             180_7  COME_FROM            42  '42'
...
Instruction context:
 ...
 L. 254       178  LOAD_FAST                'self'
                 180  LOAD_METHOD              _MixerController__reassign_strips
                 182  CALL_METHOD_0         0  '0 positional arguments'
                 184  POP_TOP          
                 186  JUMP_FORWARD        188  'to 188'
               188_0  COME_FROM           186  '186'
               188_1  COME_FROM           154  '154'
               188_2  COME_FROM           144  '144'
               188_3  COME_FROM           132  '132'
               188_4  COME_FROM           124  '124'
               188_5  COME_FROM           116  '116'
               188_6  COME_FROM            84  '84'
->             188_7  COME_FROM            66  '66'
...
Instruction context:
 ...
 L. 273        72  LOAD_FAST                'self'
                  74  LOAD_METHOD              _MixerController__set_slider_mode
                  76  LOAD_GLOBAL              SLIDER_MODE_SEND
                  78  CALL_METHOD_1         1  '1 positional argument'
                  80  POP_TOP          
                  82  JUMP_FORWARD         84  'to 84'
                84_0  COME_FROM            82  '82'
                84_1  COME_FROM            70  '70'
                84_2  COME_FROM            62  '62'
                84_3  COME_FROM            54  '54'
                84_4  COME_FROM            42  '42'
->              84_5  COME_FROM            26  '26'
...
Instruction context:
 ...
 L. 314       244  LOAD_FAST                'self'
                 246  LOAD_METHOD              _MixerController__on_transport_lock_changed
                 248  CALL_METHOD_0         0  '0 positional arguments'
                 250  POP_TOP          
                 252  JUMP_FORWARD        254  'to 254'
               254_0  COME_FROM           252  '252'
               254_1  COME_FROM           232  '232'
               254_2  COME_FROM           224  '224'
               254_3  COME_FROM           204  '204'
               254_4  COME_FROM           188  '188'
               254_5  COME_FROM           168  '168'
               254_6  COME_FROM           152  '152'
               254_7  COME_FROM           138  '138'
               254_8  COME_FROM           122  '122'
               254_9  COME_FROM           108  '108'
->            254_10  COME_FROM            92  '92'

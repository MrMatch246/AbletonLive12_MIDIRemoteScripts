...
# Size of source mod 2**32: 430819 bytes
...
BANK_DEFINITIONS = {'AudioEffectGroupDevice':RACK_BANKS, 
 ...
 'F2 Drive'), 
  ...
  (
   ...
   {BANK_PARAMETERS_KEY: (
                          ...
                          use("AEG1 < Vel").if_parameter("Env Select").has_value("Amp 1").else_use("AEG2 < Vel").if_parameter("Env Select").has_value("Amp 2").else_use("FEG1 < Vel").if_parameter("Env Select").has_value("Flt 1").else_use("FEG2 < Vel").if_parameter("Env Select").has_value("Flt 2")), 
 ...
 'Noise Sustain', 'Noise Release', 'Noise Volume'), 
  ...
  (
   ...
   {BANK_PARAMETERS_KEY: (
                          ...
                          "Resonator",
                          use("Res 1 Volume").if_parameter("Resonator").has_value("Res 1").else_use("Res 2 Volume"),
                          use("Res 1 Bleed").if_parameter("Resonator").has_value("Res 1").else_use("Res 2 Bleed"),
                          use("Res 1 Pan").if_parameter("Resonator").has_value("Res 1").else_use("Res 2 Pan"),
                          ""), 
 ...
 'OriginalSimpler':IndexedDict((
  ...
  (
   ...
   {BANK_PARAMETERS_KEY: (
                          ...
                          "L Offset",
                          "L Attack",
                          use("L R < Key").with_name("Key > Rate"),
                          use("Vol < LFO").with_name("LFO > Vol"),
                          use("Pan < LFO").with_name("LFO > Pan"),
                          use("Pitch < LFO").with_name("LFO > Pitch")), 
    
    OPTIONS_KEY: ('LFO Sync Type', 'LFO Retrig', '', '', '', 'LFO')}),
  (
   "Pan & PB",
 ...
 'MidiVelocity':IndexedDict((
  (
   BANK_MAIN_KEY,
   {BANK_PARAMETERS_KEY: ('Mode', 'Out Hi', 'Out Low', 'Drive', 'Compand', 'Range', 'Lowest', 'Random'), 
    
    OPTIONS_KEY: ('', '', '', '', '', '', 'Operation')}),)), 
 'Amp':IndexedDict((
  (
   "Global",

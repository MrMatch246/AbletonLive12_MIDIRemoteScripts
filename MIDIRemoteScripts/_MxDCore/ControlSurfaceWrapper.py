...
class LocalControlSurfaceWrapper(ControlSurfaceWrapper):
    ...
    @property
    def control_names(self):
        return [control.name for control in self._control_surface.controls if old_hasattr(control, "name") if control.name if old_hasattr(control, "name") if control.name]
...
# okay decompiling ./MIDIRemoteScripts/_MxDCore/ControlSurfaceWrapper.pyc

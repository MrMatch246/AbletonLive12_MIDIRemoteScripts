...
# [GCC 9.4.0]
# Embedded file name: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Keystage\elements.py
...
# okay decompiling ./MIDIRemoteScripts/Keystage/elements.pyc
